  ...
  <a href="/" className="flex items-center">
    ...
    />
          ...
          <div className="flex items-center justify-end gap-5">
            <a href="https://wa.me/213560034559" className="hidden lg:flex items-center gap-2 text-sm text-ivory/90 hover:text-brass transition-colors">
              <MessageCircle size={16} />
              WhatsApp
            </a>
            <a href="tel:+213560034559" className="hidden lg:flex items-center gap-2 text-sm text-ivory/90 hover:text-brass transition-colors">
              <Phone size={16} />
              0560 03 45 59
            </a>
